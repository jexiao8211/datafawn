...
# # Deer in church (hard)
# EXAMPLE_DATA_PATH = "data/pose_estimates/vid1_superanimal_quadruped_hrnet_w32_fasterrcnn_resnet50_fpn_v2_.h5"
# EXAMPLE_VIDEO_PATH = 'data/raw_videos//vid1_superanimal_quadruped_hrnet_w32_fasterrcnn_resnet50_fpn_v2__labeled_before_adapt.mp4'
...
dlc_estimator = datafawn.DeepLabCutPoseEstimator(
    ...
    max_individuals=1,
    pcutoff=0.15,
    dest_folder='data/pose_estimates/examples/deerrunning',
    device=device
)
...
zeni_extractor = datafawn.ZeniExtractor(
    ...
    prominence_percentage=0.2,
    orientation_likelihood_threshold=0.1,
    orientation_smooth_window_size=20,
    show_plots=True
)
...
results = pipeline.run(
    ...
    # pose_data_path=EXAMPLE_DATA_PATH,     # use pose estimate data if you already have it
)
